...
- All you need is to distribute your app in the iTunes Store or Google Play. Expo can [build binaries for you](../distribution/building-standalone-apps.mdx) in that case. If you eject, we can't automatically build for you any more.
