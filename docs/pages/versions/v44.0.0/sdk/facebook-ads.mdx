---
title: FacebookAds
sourceCodeUrl: 'https://github.com/expo/expo/tree/sdk-44/packages/expo-ads-facebook'
---
...
- To use your app's own Facebook App ID (and thus see any related ad info in your Facebook developer page), you'll need to [build a standalone app](../../../distribution/building-standalone-apps.mdx).
