...
Permissions in standalone and [development builds](/development/introduction.mdx) require native build-time configuration before they can be requested using runtime JavaScript code. This is not required when developing projects in the [Expo Go][expo-go] app.
