...
To read `extra` properties in your app, you can use the [`expo-constants`](/versions/latest/sdk/constants.mdx) library. The `extra` property is available on the `Constants.expoConfig` property.
