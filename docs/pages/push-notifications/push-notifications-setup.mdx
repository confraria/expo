...
For Android, both managed and bare workflow users need to follow our [FCM setup guide](using-fcm.mdx), it should only take about 5 minutes.
...
Try out [sending a notification with Expo](./sending-notifications.mdx)!
