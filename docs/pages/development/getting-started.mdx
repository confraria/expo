...
If you have used Expo before, [config plugins](/guides/config-plugins.mdx) allow you to customize your project from JavaScript without ever needing to directly modify your project in Xcode or Android Studio.
...
However you choose to manage your native projects, we recommend using [EAS Build](eas-build.mdx) for the smoothest experience, especially if you do not have experience with Xcode and Android Studio builds.

After you configure your project as covered by the [Building with EAS guide](eas-build.mdx), you're ready to create your build.
...
After creating the first build, [install it on your device](/build/internal-distribution.mdx).
...
In Expo Go, you can already convert text to audio with [expo-speech](/versions/latest/sdk/speech.mdx), but what if you want to go the other direction and convert audio to text? The community module [`@react-native-voice/voice`](https://github.com/react-native-voice/voice) provides this capability, and thanks to config plugins, you can add it to your project!
